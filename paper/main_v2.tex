...
call that spread a fully manifested noise floor. An initial E1 trace
found a step-0 optimizer-ownership mismatch; after the ownership repair,
the revision-scoped R12 trace passed all 2,986 designated comparisons.
That trace does not establish standalone checkpoint replay or metric
equivalence. We report the two misses as open implementation questions rather than evidence
